...
const fixturesDir = 'src/data-importer/parser/__fixtures__/dev-data';

describe('parsing development', () => {
  describe('CauselistMultiDocumentParser', () => {
    ...
    it.each(documents)('should parse textContent $fileSha1', (document) => {
