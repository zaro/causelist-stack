...
export interface RemoveCorrectionDialogProps {
  open: boolean;
...
export default function RemoveCorrectionDialog({
  open,
  infoFile,
  onClose,
  onComplete,
  ...
  return (
    ...
    >
      ...
      <form
        method="POST"
        action={`/api/info-files/remove-correction/${infoFile?.id}`}
        onSubmit={onSubmit}
      >
        <DialogContent>
          ...
          <DialogContentText variant="body2">
            Do you want to remove the corrected version for this file?
          </DialogContentText>
